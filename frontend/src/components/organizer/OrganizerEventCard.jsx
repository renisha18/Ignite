    ...
    <Card as="li" className="list-none">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2">
          {/* events.event_type — absent on events created before the
              column existed, and on any left deliberately untyped. */}
          {event.eventType && (
            <span className="rounded-full border-2 border-ink bg-cream px-2 py-0.5 text-[11px] font-bold text-ink">
              {event.eventType}
            </span>
          )}
